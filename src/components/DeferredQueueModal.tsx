            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-xs">
                ...
                <p className="mt-1 leading-relaxed text-[#3C4043]">
                  Cuando los modelos en cascada (gemini-3.8-flash → gemini-3.1-flash-lite → gemini-3.1-pro-preview) agotan su cuota de peticiones simultáneas, las llamadas se resguardan aquí para ser reintentadas automáticamente sin perder datos.
                </p>
              </div>
            </div>
          </div>
